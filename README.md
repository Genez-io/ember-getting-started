...
3. **Modify the Template**
   ...
   - `app/templates/application.hbs`: Entry point for the Ember application.
   - `app/app.js`: Entry point for the Ember application.
   - `app/router.js`: Router for the Ember application.
   - `styles/app.css`: CSS styles for the Ember application.


# Deploy
:rocket: You can deploy your own version of the template to Genezio with one click:

[![Deploy to Genezio](https://raw.githubusercontent.com/Genez-io/graphics/main/svg/deploy-button.svg)](https://app.genez.io/start/deploy?repository=https://github.com/Genez-io/ember-getting-started)
